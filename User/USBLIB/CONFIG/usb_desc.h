...
#define USBD_SIZE_STRING_VENDOR      (DEV_STRING_VENDOR_LEN + 2)
#define USBD_SIZE_STRING_PRODUCT     (DEV_STRING_PRODUCT_LEN + 2)
#define USBD_SIZE_STRING_SERIAL      (DEV_STRING_SERIAL_LEN + 2)
